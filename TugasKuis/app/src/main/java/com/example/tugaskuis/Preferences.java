...
public class Preferences {
    ...
    static final String KEY_USER_TEREGISTER ="user", KEY_PASS_TEREGISTER ="pass"
            ,KEY_EMAIL_TEREGISTER ="email", KEY_NIM_TEREGISTER ="nim";
    ...
    public static void setRegisteredNim(Context context, String nim){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_NIM_TEREGISTER, nim);
        editor.apply();
    }
    ...
    public static String getRegisteredNim(Context context){
        return getSharedPreference(context).getString(KEY_NIM_TEREGISTER,"");
    }
